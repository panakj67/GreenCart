...
const InputField = ({type, placeholder, name, handleChange, address}) => (
    ...
    focus:border-[#4fbf8b] focus:ring-[#4fbf8b] focus:ring-1'
  ...
  return (
    <div className='mt-16 pb-16'>
        <p className='text-2xl md:text-3xl text-gray-500'>Add Shipping <span
         className='font-semibold text-[#4fbf8b]'>Address</span></p>
         <div className='flex flex-col-reverse md:flex-row justify-between mt-10'>
             <div className='flex-1 max-w-md'>
                 <form onSubmit={submitHandler} className='space-y-3 mt-6 text-sm'>
                    ...
                    <InputField handleChange={handleChange} name="street" address={address} type="text"
                    placeholder="Street" />
                    ...
                    <button className='w-full mt-6 py-3 bg-[#4fbf8b] text-white font-medium hover:bg-[#44ae7c] transition
